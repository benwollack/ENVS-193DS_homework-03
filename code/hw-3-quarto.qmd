...
ggplot(
  data = kelp,
  aes(x = temp_c)) +
  # create histogram, Rice Rule says to use 6 bins
...
The shape of the temperature distribution appears roughly normal, so the normality assumption for this variable is met. We now must check for the elongation rate.
